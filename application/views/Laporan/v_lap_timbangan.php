								...
								<tr>
									...
									<td colspan="3">
										<select name="" id="jenis" class="form-control" style="margin: 5px">
											...
											<option value="11">Timbangan Keseluruhan PM 1</option>
											<option value="22">Timbangan Keseluruhan PM 2</option>
...
<script>
	function cetak(ctk) {
		...
		if (jenis == "") {
			showNotification("alert-info", "Silahkan Pilih Jenis Laporan", "bottom", "right", "", "");
			return;
		}
