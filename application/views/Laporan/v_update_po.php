                                  ...
                                  <td colspan="3">
                                    <select name="" id="jenis" class="form-control" style="margin: 5px">
                                      ...
                                      <?php
                                          ...
                                          $sql = mysql_query("SELECT b.id AS id,b.nm_perusahaan AS nm_perusahaan,b.pimpinan AS pimpinan FROM po_master a
                                          INNER JOIN m_perusahaan b ON a.id_perusahaan = b.id
                                          GROUP BY b.id,b.nm_perusahaan
                                          ORDER BY b.nm_perusahaan ASC");
                                          while($data=mysql_fetch_array($sql)) {
                                      ?>
                                      <option value="<?=$data['id']?>"><?=$data['pimpinan']?> || <?=$data['nm_perusahaan']?></option>
                                          <?php
                                            }
                                          ?>
                                    </select>
